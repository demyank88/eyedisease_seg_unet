...
if __name__ == "__main__":
    ...
    parser.add_argument("--stamp_epoch", default=245, type=int)
    ...
    parser.add_argument("--data_root", default='/mnt/d/business/alphado/dataset-003/train/tfrecords/', type=str,
                        help="Dir to data root")
    parser.add_argument("--val_data_root", default='/mnt/d/business/alphado/dataset-003/validation/tfrecords/', type=str,
    ...
    if config.mode == 'serve':
        image=cv2.imread('/mnt/d/business/alphado/dataset-003/capture_for_demo/cataract_img/AlphadoPhoto_2020-10-07 16_41_43_649.JPG')
